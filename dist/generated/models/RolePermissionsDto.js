...
exports.instanceOfRolePermissionsDto = instanceOfRolePermissionsDto;
exports.RolePermissionsDtoFromJSON = RolePermissionsDtoFromJSON;
exports.RolePermissionsDtoFromJSONTyped = RolePermissionsDtoFromJSONTyped;
exports.RolePermissionsDtoToJSON = RolePermissionsDtoToJSON;
exports.RolePermissionsDtoToJSONTyped = RolePermissionsDtoToJSONTyped;
/**
 * Check if a given object implements the RolePermissionsDto interface.
 */
function instanceOfRolePermissionsDto(value) {
...
function RolePermissionsDtoFromJSON(json) {
    return RolePermissionsDtoFromJSONTyped(json, false);
}
function RolePermissionsDtoFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function RolePermissionsDtoToJSON(json) {
    return RolePermissionsDtoToJSONTyped(json, false);
}
function RolePermissionsDtoToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
