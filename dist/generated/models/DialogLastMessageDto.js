...
exports.DialogLastMessageDtoActionTypeEnum = void 0;
exports.instanceOfDialogLastMessageDto = instanceOfDialogLastMessageDto;
exports.DialogLastMessageDtoFromJSON = DialogLastMessageDtoFromJSON;
exports.DialogLastMessageDtoFromJSONTyped = DialogLastMessageDtoFromJSONTyped;
 ...
 */
function instanceOfDialogLastMessageDto(value) {
...
function DialogLastMessageDtoFromJSON(json) {
    return DialogLastMessageDtoFromJSONTyped(json, false);
}
function DialogLastMessageDtoFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function DialogLastMessageDtoToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
