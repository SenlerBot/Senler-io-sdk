...
function DialogListItemDtoToJSONTyped(value, ignoreDiscriminator = false) {
    ...
    return {
        ...
        'active_support_sla_warning_at': value['activeSupportSlaWarningAt'] == null ? undefined : (value['activeSupportSlaWarningAt'].toISOString()),
        'active_support_sla_breach_at': value['activeSupportSlaBreachAt'] == null ? undefined : (value['activeSupportSlaBreachAt'].toISOString()),
