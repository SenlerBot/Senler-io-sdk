...
function DeliveryTestRecipientLinkResponseDtoFromJSON(json) {
    return DeliveryTestRecipientLinkResponseDtoFromJSONTyped(json, false);
}
function DeliveryTestRecipientLinkResponseDtoFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
function DeliveryTestRecipientLinkResponseDtoToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
