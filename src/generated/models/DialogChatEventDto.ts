 ...
 * @export
 */
export const DialogChatEventDtoPlatformTypeEnum = {
    Vk: 'vk',
    Tg: 'tg',
    Max: 'max',
    Discord: 'discord',
 ...
 * @export
 */
export const DialogChatEventDtoTargetTypeEnum = {
    Message: 'message',
 ...
 * @export
 */
export const DialogChatEventDtoActionTypeEnum = {
...
export function DialogChatEventDtoFromJSON(json: any): DialogChatEventDto {
    return DialogChatEventDtoFromJSONTyped(json, false);
}

export function DialogChatEventDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): DialogChatEventDto {
    if (json == null) {
        return json;
    }
    return {
...
export function DialogChatEventDtoToJSON(json: any): DialogChatEventDto {
    return DialogChatEventDtoToJSONTyped(json, false);
}

export function DialogChatEventDtoToJSONTyped(value?: DialogChatEventDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
