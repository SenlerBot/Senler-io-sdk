...
export interface ServerTemplateResponseDto {
    ...
    /**
     * URL аватарки готового MCP сервера.
     * @type {string}
     * @memberof ServerTemplateResponseDto
     */
    ...
    /**
     * Теги готового MCP сервера (может быть пустым массивом).
     * @type {Array<string>}
     * @memberof ServerTemplateResponseDto
     */
    tags: Array<string>;
    /**
     * Категории готового MCP сервера (может быть пустым массивом).
     * @type {Array<ServerTemplateCategoryDto>}
     * @memberof ServerTemplateResponseDto
     */
    categories: Array<ServerTemplateCategoryDto>;
    /**
     * Количество установок (динамическое).
     * @type {number}
     * @memberof ServerTemplateResponseDto
     */
    installCount: number;
    /**
     * Популярный готовый MCP сервер (топ-10 по установкам).
     * @type {boolean}
     * @memberof ServerTemplateResponseDto
     */
    isFeatured: boolean;
