...
export function DialogListItemDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): DialogListItemDto {
    ...
    return {
        ...
        'activeConversationSegmentId': json['active_conversation_segment_id'] == null ? undefined : json['active_conversation_segment_id'],
        'activeConversationSegmentOpenedAt': json['active_conversation_segment_opened_at'] == null ? undefined : (new Date(json['active_conversation_segment_opened_at'])),
...
export function DialogListItemDtoToJSONTyped(value?: DialogListItemDto | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'active_conversation_segment_id': value['activeConversationSegmentId'],
        'active_conversation_segment_opened_at': value['activeConversationSegmentOpenedAt'] == null ? undefined : ((value['activeConversationSegmentOpenedAt']).toISOString()),
